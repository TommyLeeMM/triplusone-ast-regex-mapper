 ...
 */
	function _getLogger($loggerName) {
		...
		if ($plugin) {
			uses(Inflector::singularize(Inflector::tableize($plugin)) . DS . 'log' . DS . Inflector::singularize(Inflector::tableize($loggerName)));
		} else {
			uses('log' . DS . Inflector::singularize(Inflector::tableize($loggerName)));
		}
